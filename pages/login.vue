	  ...
	  <div class="hero-body">
	    <div class="container">
	      <div class="columns is-centered">
	        ...
	        <h5 class="title is-5 has-text-centered">USER LOGIN</h5>
	        <div class="card">
...
<script>
	export default{
		...
		methods:{
			async logInUser(){
			this.creating = true;
			await this.$axios.$post( this.$store.state.api_url + '/users/login', {
					email: this.email,
			    ...
			    .then((response)=>{
			    	...
			    	this.$store.dispatch('setTokenUser',{token,user});
