	...
	<section class="section" style="margin-top: 30px;">
		...
		<div class="columns" v-if="breadcrumb=='create_new'" style="justify-content: center;">
			<div class="column is-6-tablet is-5-desktop is-4-widescreen" >
				...
				<div class="field">
				   <label class="label text-small">Email</label>
				   <div class="control">
				...
				<div class="field">
	              <label for="" class="label text-small">Password</label>
	              <div class="control has-icons-left">
	            ...
	            <div class="field">
	              <label for="" class="label text-small">Confirm Password</label>
	              <div class="control has-icons-left">
			...
			<div class="column is-6-tablet is-5-desktop is-4-widescreen" >
				...
				<div class="field">
				   <label class="label text-small">Phone</label>
				   <div class="control">
				...
				<div class="field">
				   <label class="label text-small">Designation</label>
				   <div class="control">
				...
				<div class="field">
				   <label class="label text-small">Subject</label>
				   <div class="control">
